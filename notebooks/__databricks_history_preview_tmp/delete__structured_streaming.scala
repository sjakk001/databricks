...
import com.cisco.ciscoImpact.datalake.streaming.delete._
...
val stream = new AddDeleteStream(spark,params)



// Get or create a streaming context.
 val ssc = StreamingContext.getActiveOrCreate(params.checkpointDir, stream.creatingFunc _)
